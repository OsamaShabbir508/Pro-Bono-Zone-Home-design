        ...
        <>
            ...
            <div className='flex  flex-col items-center justify-center sm:flex-col md:flex-row md:justify-evenly md:items-center lg:flex-row lg:items-center lg:justify-evenly mx-4 px-0 py-0 md:px-8 md:py-20 lg:px-8 lg:py-20'>
                <div className=' sm:w-full md:w-[50%] lg:w-[50%] '>
                    ...
                    <p className='mt-6 text-[#414141]'>Ten minutes with a law student at a "free legal aid" community clinic is fine if you want tounderstand who gets grandma's furniture, but if you need to take care of something importantor potentially life-changing, consult with a competent professional. It's free.</p>
            ...
            <div className='  py-10 relative '>
                ...
                <h1 className='text-3xl text-white font-bold mt-4 text-center py-6 '> Your Advocate</h1>
            ...
            <div className=' py-16 bg-slate-100  flex  flex-col justify-center items-center '>
                <h1 className='text-3xl font-bold mt-4 text-center py-6 '>Schedule A Consultation</h1>
                <p className=' text-center  text-sm mt-2 px-5 mb-4 md:px-64 lg:px-64'>This event will last just 4 hours, so we have limited openings. If you need legal advice, don't delay.
                    Take advantage of this opportunity to move forward. You owe it to yourself.</p>
                ...
                <div className='bg-[#ffff] px-4 py-4 md:py-10 md:px-16 lg:py-10 lg:px-16  w-[100%] md:w-[90%] lg:w-[70%] flex flex-col justify-center items-center sm:flex-col md:flex-row lg:flex-row'>
                    <div className='w-[100%] md:w-[50%] lg:w-[50%]  '>
                        ...
                        <div className='flex  flex-row items-center flex-wrap mt-4 '>
                        ...
                        </div> <div className='flex  flex-row items-center flex-wrap mt-4'>
                            ...
                            <div className='flex  flex-col '>
                                ...
                                <p className='ml-2 text-[#061133] text-sm'>Suite 251, 2356 Main Street, Lehi, Utah </p>
                            </div>
                        </div>
                    ...
                    <div className='w-[100%] md:w-[50%] lg:w-[50%]  '>
                        <div className='flex flex-col justify-center md:flex-row lg:flex-row  flex-wrap  '>
                            <input type='text' className='py-2 px-4 bg-gray-100 text-sm text-[#414141] rounded-sm m-2' placeholder='First Name'></input>
                            <input type='text' className='py-2 px-4 bg-gray-100  text-sm text-[#414141] rounded-sm m-2' placeholder='First Name'></input>
                        </div>
                        <div className='flex flex-col justify-center md:flex-row lg:flex-row  flex-wrap  '>
                            <input type='text' className='py-2 px-4 bg-gray-100  text-sm text-[#414141] rounded-sm m-2' placeholder='First Name'></input>
                        ...
                        <div className='flex flex-col justify-center md:flex-row lg:flex-row  flex-wrap  '>
                            ...
                            <textarea name="" id="" placeholder='How did you hear about Pro Bono Zone?' className='bg-gray-100 px-4 m-auto w-full md:w-96 lg:w-96 h-20 md:m-2'></textarea>
                        </div>
                        <div className=' flex justify-center mt-6  md:justify-center lg:justify-center '>
                            <Button buttonText={'Count Me In'} />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className='bg-[#061133] '>
                <div className='flex flex-row justify-center items-center flex-wrap pt-8  m-2 '>
                    <h1 className='text-2xl font-bold text-white px-5 '>Newsletter Sign Up</h1>
                    <div className='bg-gray-600 w-72 sm:w-96 md:w-96 lg:w-96  h-12 rounded-sm  md:m-5  lg:m-5'><input placeholder='Enter your email here...' className='w-48 sm:w-72 md:w-72 lg:w-72 h-12 px-4 text-sm text-[#FFFFFF] bg-transparent border-none outline-none' /><button className='bg-[#4270FF] rounded-md px-5 py-2  text-sm text-white'>Register</button></div>
                </div>
                <div className='flex flex-col  md:flex-row  md:justify-evenly  lg:flex-row  lg:justify-evenly   md my-8 py-5'>
